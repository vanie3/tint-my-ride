(function($){
     $.fn.parallaxSlider=function(o){ 
        ...
        function init(){
            ...
            _this.append("<div id='mainCaptionHolder'><div class='container'><div class='slidesCounter'></div><div class='controlBtn parallaxPrevBtn'><div class='innerBtn icon-angle-left'></div></div><div class='controlBtn parallaxNextBtn'><div class='innerBtn icon-angle-right'></div></div><div class='extraslidercontainer'><div class='primaryCaption'></div><div class='secondaryCaption'></div></div></div></div>");
